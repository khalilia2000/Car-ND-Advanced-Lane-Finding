...
def replace_frame(frame_img):
    ...
    # check to see if curvatures are similar between right and left lanes - Delta(1/curve_rad) <= 0.0025
    detected = detected and (abs(1/result[0][0]['curve_rad']-1/result[0][1]['curve_rad'])<=0.0025)
